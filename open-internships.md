...
### J141 开源项目实习经理（PM岗）（20250311 开放 20 名）
...
### J126 openKylin 开发实习生【甲辰计划联合实习生培养】（暂停招聘）
...
### BJ108 RISC-V 测试实习生（北京坐班）（20250311 开放）
...
**岗位1：RISC-V 开发板软件生态联合观测实习生**

目前进行中/已完成的工作可查看 [ruyisdk/support-matrix](https://github.com/ruyisdk/support-matrix) 仓库。

而这项工作的技术门槛并不高，需要耐心和细心，适合对 RISC-V 硬件和软件有兴趣的同学们快速参与进来。
...
- 能力等级：LV2+ 或“一生一芯”学习经历证明。
- 大学英语四级/六级或同等水平，能够在即时通讯软件、国际开源社区流畅与外国人交流的程度，能够做简单的技术文档翻译工作。
- 使用过至少一种 Linux 发行版操作系统，能够独立看着官方文档进行配置以自己日常使用需求的程度。
- 微信等即时通讯软件响应速度快。尤其是工作日。
- 做事细心、有耐心。有良好的沟通表达能力。
- Bonus: 使用/调试过至少一款开发板，当然，如果是 RISC-V 开发板更好。
- Bonus²: 有和社区对线（非暴力沟通）的经验。

**岗位2：RISC-V SAIL 和 ACT 测试开发实习生**
...
包括但不仅限于以下项目：
1. ROS机器人操作系统（室内移动机器人，无人机，自动驾驶）
2. 机器学习（生成式AI，目标检测，增强学习，回归，无监督学习）
3. 嵌入控制（GPIO,传感器等）
4. 教学仿真（QTRVSim等）
5. 应用开发
...
### BJ107 DynamoRIO RISC-V 移植开发实习生（20250311 开放 1 名）
...
### BJ88 RISC-V SAIL 开发实习生（20250311 开放 20 名）
...
### BJ18 Clang/LLVM 开发实习生（20250319 开放 30 名）
